...
jest.mock('../../services/Dashboard.service', () => ({
    ...
    getMaxMinInterval: jest.fn().mockResolvedValue({ max: [{ producer: 'Producer1', interval: 10, previousWin: 2020, followingWin: 2030 }], min: [{ producer: 'Producer2', interval: 5, previousWin: 2010, followingWin: 2015 }] }),
    getStudiosWithWinCount: jest.fn().mockResolvedValue({ studios: [{ name: 'Studio1', winCount: 5 }, { name: 'Studio2', winCount: 3 }, { name: 'Studio3', winCount: 10 }] }),
    findMovieWinnersByYear: jest.fn().mockResolvedValue([{ id: 1, year: 2021, title: 'Movie1' }, { id: 2, year: 2021, title: 'Movie2' }])
}));
